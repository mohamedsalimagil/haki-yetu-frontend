...
import { 
  ...
  FileCheck, DollarSign, ChevronRight, ChevronDown, Download, Eye
} from 'lucide-react';
import { notarizationQueue, lawyerStats } from '../../data/mockLawyerData';
      ...
      <main className="flex-1 lg:ml-64 p-8 overflow-y-auto">
        ...
        <header className="mb-8">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div>
              <h1 className="text-2xl font-bold text-[#0A1E41]">Notarization Queue</h1>
          ...
          <div className="bg-white p-5 rounded-2xl border border-gray-100 shadow-sm">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <h3 className="text-2xl font-bold text-[#0A1E41]">{lawyerStats.pendingNotarizations}</h3>
              </div>
            </div>
          </div>
                  ...
                  <tr key={item.id} className="hover:bg-gray-50 transition">
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center">
                        ...
                        <div className="ml-3">
                          <div className="text-sm font-semibold text-[#0A1E41]">{item.client.name}</div>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <span className={`text-sm font-medium ${
                        item.deadline.includes('Today') ? 'text-red-600' : 'text-slate-600'
                      }`}>
                        {item.deadline}
                      </span>
                    </td>
