      ...
      <div className="bg-white border-b border-gray-200 py-4 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center gap-2 text-sm text-gray-600">
            ...
            <span>/</span>
            <button onClick={() => navigate('/client/support')} className="hover:text-blue-600">My Cases</button>
            <span>/</span>
                ...
                {uploadedFiles.length > 0 && (
                  <div className="mt-4 space-y-2">
                    {uploadedFiles.map((file, index) => (
                      <div key={index} className="flex items-center justify-between bg-red-50 px-4 py-2 rounded-lg border border-red-200">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  {[
                    ...
                    return (
                      <label
                        key={method.value}
                        className={`relative flex flex-col items-center p-6 border-2 rounded-lg cursor-pointer transition ${
                      ...
                      >
                        ...
                        <Icon className={`w-6 h-6 mb-3 ${
                          formData.resolutionMethod === method.value ? 'text-blue-600' : 'text-gray-600'
                        }`} />
                        <span className="font-semibold text-gray-900 mb-1">{method.label}</span>
