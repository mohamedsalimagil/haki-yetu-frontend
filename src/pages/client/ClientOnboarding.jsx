          ...
          <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <div className="grid grid-cols-3 gap-4">
                  <button
                    ...
                    className={`py-2.5 px-4 rounded-lg border-2 font-bold text-sm transition ${
              ...
              <div>
                ...
                <input type="text" name="documentNumber" value={formData.documentNumber} onChange={handleChange} placeholder="e.g. 12345678" className="w-full px-4 py-3 rounded-lg border border-gray-200 focus:ring-2 focus:ring-blue-500 outline-none" required />
              </div>
              ...
              <div>
                ...
                <select name="county" value={formData.county} onChange={handleChange} className="w-full px-4 py-3 rounded-lg border border-gray-200 focus:ring-2 focus:ring-blue-500 outline-none bg-white">
              ...
              <div>
                ...
                <input type="text" name="address" value={formData.address} onChange={handleChange} placeholder="e.g. Westlands, Chiromo Road, Mirage Towers" className="w-full px-4 py-3 rounded-lg border border-gray-200 focus:ring-2 focus:ring-blue-500 outline-none" required />
              </div>
                ...
                <div className={`grid gap-4 ${selectedDocumentType === 'passport' ? 'grid-cols-1' : 'grid-cols-1 md:grid-cols-2'}`}>
                  ...
                  >
                    ...
                    <span className="text-xs text-gray-400 mt-1">
                      {idFront ? (
                        <>
                          <span className="text-green-600 font-medium">{(idFront.size / 1024).toFixed(1)}KB</span> - Click to change
                        </>
                      ) : (
                  ...
                  {selectedDocumentType !== 'passport' && (
                    ...
                    >
                      ...
                      <span className="text-sm font-medium text-gray-700 text-center">{idBack ? idBack.name : 'ID Back Side'}</span>
                      <span className="text-xs text-gray-400 mt-1">
                        {idBack ? (
                          <>
                            <span className="text-green-600 font-medium">{(idBack.size / 1024).toFixed(1)}KB</span> - Click to change
                          </>
                        ) : (
                          'Click to upload (JPG, PNG, PDF)'
                        )}
              ...
              {loading && uploadProgress > 0 && (
                <div className="bg-blue-50 border border-blue-200 rounded-xl p-4">
                  ...
                  <p className="text-xs text-blue-700 mt-2">Please do not close this page...</p>
                </div>
              )}
              ...
              <div className="flex items-center gap-4 pt-4">
                ...
                <button
                  ...
                  disabled={saving}
                  className="px-6 py-3.5 border border-gray-300 text-gray-700 font-medium hover:bg-gray-50 transition rounded-lg disabled:opacity-50"
                >
