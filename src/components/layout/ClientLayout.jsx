        ...
        <div className="flex min-h-screen bg-gray-50">
            <aside className="w-64 bg-white border-r border-gray-200 flex flex-col p-4">
                ...
                <nav className="flex-1 space-y-2 mt-6">
                    ...
                    <button onClick={()=>navigate('/client/marketplace/templates')} className="flex items-center gap-3 w-full p-3 hover:bg-blue-50 text-gray-700 rounded-lg"><FileText size={20}/> Templates Marketplace</button>
